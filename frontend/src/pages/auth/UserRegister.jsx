...
function UserRegister() {
    ...
    const registerSubmit = async e => {
        e.preventDefault()
        try{
            await AxiosInstance.post('/user/signup',user,{withCredentials:true}).then(async (response) => {
        ...
        <Container style={{marginTop:5,marginBottom:5,display:"flex",justifyContent:"center"}}>
            <Card style={{paddingBlock:4,paddingInline:1,borderRadius:12,border:"none",width:400}}>
                <Card.Body>
                    ...
                    <h6 style={{marginTop:4,fontSize:16,fontStyle:"italic",fontWeight:"lighter"}}>*You are registering as a client</h6>
